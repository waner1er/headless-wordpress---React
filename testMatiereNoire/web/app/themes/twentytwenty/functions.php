...
function create_post_type() {
    ...
    $labels = array(
		...
		'add_new_item'        => __( 'Ajouter une new liste de News'),
		'add_new'             => __( 'Ajouter une new'),
		'edit_item'           => __( 'Editer la new'),
		'update_item'         => __( 'Modifier la new'),
		'search_items'        => __( 'Rechercher une new'),
